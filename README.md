...
3. The app shows the plugin inventory; the chat tab picks one of the host's sessions and streams the assistant reply live; the settings tab renders every namespace as a JSON view (editing is not implemented yet).
